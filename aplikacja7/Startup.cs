...
using aplikacja7.ModelsDBFirst;
...
namespace aplikacja7
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<s16478Context>(options => 
                    options.UseSqlServer(Configuration.GetConnectionString("Data Source=db-mssql;Initial Catalog=s16478;Integrated Security=True")));
